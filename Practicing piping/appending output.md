...
## Solution
Used /challenge/run >> /home/hacker/the-flag to append mode redirect the output and used cat /home/hacker/the-flag to view flag.
```sh
Connected!
...
\|/ This is the first half:
 v
pwn.college{AGzuoqiBTlKFBIKcB0nZUYGZC0-.QX3ATO0wCM0AzNzEzW}
                              ^
